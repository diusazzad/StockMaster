<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- <li><a href="
                {{-- {{ route('sales.index') }} --}}
                "><i class="fa fa-cart-plus"></i> <span>Penjualan</span></a></li> -->
            <li><a href="
            ...
            {{-- {{ route('productsOut.index')}} --}}
              "><i class="fa fa-minus"></i> <span>Outgoing
                        Products</span></a></li>
            <li><a href="
            {{-- {{ route('productsIn.index')}} --}}
            "><i class="fa fa-cart-plus"></i> <span>Purchase
                        Products</span></a></li>
            <li><a href="
                {{-- {{ route('user.index')}}" --}}
            ><i class="fa fa-user-secret"></i>
                    <span>System Users</span></a></li>
