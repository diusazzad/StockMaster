...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            ...
            <a href=
            {{-- "{{ route('exportPDF.productMasukAll') }}" --}}
             class="btn btn-danger"><i class="fa fa-file-pdf-o"></i>
                Export PDF</a>
            <a href=
            {{-- "{{ route('exportExcel.productMasukAll') }}"  --}}
            class="btn btn-primary"><i class="fa fa-file-excel-o"></i>
                Export Excel</a>
        </div>
            ...
            <table id="invoice" class="table table-bordered table-hover table-striped">
                ...
                {{-- @foreach ($invoice_data as $i) --}}
                    <tbody>
                        ...
                        <td>
                            <a href="
                            {{-- {{ route('exportPDF.productMasuk', ['id' => $i->id]) }} --}}
                            "
                                class="btn btn-sm btn-danger">Export Invoice</a>
                        </td>
                    </tbody>
                {{-- @endforeach --}}
            </table>
